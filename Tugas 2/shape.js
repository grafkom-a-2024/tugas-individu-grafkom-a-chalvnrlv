...
function createTriangleBuffer(gl) {
    const vertices = [
        ...
        // Depan roket orange
        -0.4, 0.1,   1.0, 0.5, 0.0,  // Kanan Atas (Orange)
        -0.8, -0.4,  1.0, 0.5, 0.0,  // Ujung (Orange)
        -0.4, -0.4,  1.0, 0.5, 0.0,  // Kanan bawah (Orange)

        // Jetnya orange
        0, -0.15,    1.0, 0.5, 0.0,  // Tengah (Orange)
        0.2, -0.3,   1.0, 0.5, 0.0,  // (Orange)
        0.2, 0,      1.0, 0.5, 0.0,  // (Orange)

        // Badan Roket orange
        -0.4, 0.1,   1.0, 0.5, 0.0,  // Kiri Atas (Orange)
        0.1, 0.1,    1.0, 0.5, 0.0,  // Kanan Atas (Orange)
        -0.4, -0.4,  1.0, 0.5, 0.0,  // Kiri bawah (Orange)

        0.1, -0.4,   1.0, 0.5, 0.0,  // Kanan Bawah (Orange)
        0.1, 0.1,    1.0, 0.5, 0.0,  // Kanan Atas (Orange)
        -0.4, -0.4,  1.0, 0.5, 0.0,  // Kiri bawah (Orange)

        // Jendela
        -0.4, 0,     1, 1, 1,  // Kanan Atas (Gray)
        -0.7, -0.35,  0.5, 0.5, 0.5,  // Ujung (Gray)
        -0.4, -0.35,  1, 1, 1,   // Kanan bawah (Gray)

        // Api Jet
        0.5, -0.15,    1, 0, 0,  // Tengah (Red)
        0.2, -0.3,   1, 1, 0.0,  // (Yellow)
        0.2, 0,      1, 1, 0.0,  // (Yellow)

        0.5, -0.07,    1, 0, 0,  // Tengah (Red)
        0.2, -0.3,   1, 1, 0.0,  // (Yellow)
        0.2, 0,      1, 1, 0.0,  // (Yellow)
    ];
